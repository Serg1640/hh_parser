...
1) Создается (подключается) база данных для последующего создания таблицы вакансий. В рамках создания структурированного запроса можно изменять количество полей.
