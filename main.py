...
#создание базы данных, в случае, если база данных уже существует, необходимо закомментировать
# conn = psycopg2.connect(dbname="postgres", user="postgres", password="Rezdbzq16401", host="127.0.0.1")
# cursor = conn.cursor()
#
